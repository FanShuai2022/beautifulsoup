...
class BeautifulSoup(Tag):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param replacer: A SoupReplacer object that will transform tag
         names during parsing. This allows you to replace one tag
         name with another as the document is being parsed.
        ...
        # store replacer for later use when we create tags
